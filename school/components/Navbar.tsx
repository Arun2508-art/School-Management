    ...
    <>
      <div className='flex items-center justify-end p-4'>
        ...
        <div className='flex gap-4  lg:gap-5 items-center'>
          <div
            className='bg-white w-7 h-7 flex items-center justify-center cursor-pointer hover:bg-Purple rounded-md'
            onClick={handleModal}
          >
            <Image src='/message.png' alt='' width={20} height={20} />
          </div>
          <div
            className='bg-white w-7 h-7 flex items-center justify-center cursor-pointer relative hover:bg-Purple rounded-md'
            onClick={handleModal}
          >
